...
changeskills=(e)=>{
    ...
    let SkillRating = document.getElementById('inputRating'+SkillIndex);
...
updateJobskills = () => {
    ...
    submitJob=(e)=>{
        ...
        this.state.Job.Date = this.props.GetDate()
                              ...
                              console.log(result)
                                ...
                                this.state.JobSkills.map((Skill)=>{ 
                                    ...
                                    if(result!='Failed to Add'){
                                      ...
                                      .then((result)=>{
                                        console.log(result)
                                            this.NotifieWorker(this.state.Job,Job_ID,jobskills)
    ...
    render(){
        {
            ...
            return(
                <div className="modal fade " id="Add_Job" tabIndex="-1" aria-hidden="true">
                ...
                <form onSubmit={this.submitJob}>
                        <h2 className='text-light text-center'>New Job</h2>
                        ...
                        <div className="inputanim m-1">
                                ...
                                <div className='Skilllist'>
                                    ...
                                    {FilterSkills.map((skill, i) => (
                                        ...
                                        <input className='ms-auto p-0 m-1 text-center' type="text" key-s={skill.id} key-rt={null} id={'inputRating'+skill.id} style={CheckedSkills.includes(skill.id)?{width:'60px'}:{width:'60px',display:'none'}} title='Rating between 1 and 5...' placeholder='1 to 5' onChange={this.changeskillRating}/>
                                        </div>
                                    ))}
                                </div>
                        </div>
                        <hr/>
                    <button className='btn actionCartPro m-3' data-bs-dismiss="modal" aria-label="Close" type="submit">{isLoadingregister?<div className='loadersmall'style={{border: '4px solid rgb(36 29 29 / 36%)',borderLeftColor: 'transparent'}}></div>:'Add Job'}</button>
                    </form>
                    </div>
                    </div> 
                    </div>
